...
class FindAllPersonsServiceTest {
    ...
    @InjectMocks
    FindAllPersonsService findAllPersonsService;

    @Test
    public void SuccessFindAllPersonsService() {

        List<PersonResponse> personList = List.of(
                new PersonResponse(1L, "john.doe@example.com", "John", "Michael",
                        "Doe", LocalDate.of(1990, 1, 1)),
                new PersonResponse(2L, "jane.smith@example.com", "Jane", "Emily",
                        "Smith", LocalDate.of(1985, 5, 20)),
                new PersonResponse(3L, "alex.jones@example.com", "Alex", "James",
                        "Jones", LocalDate.of(1992, 12, 15))
        );
