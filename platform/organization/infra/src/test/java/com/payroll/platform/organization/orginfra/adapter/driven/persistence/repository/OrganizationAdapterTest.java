...
class OrganizationAdapterTest {
  @Mock OrganizationPostgresRepository repository;

  @InjectMocks OrganizationAdapter adapter;

  @Test
  public void createOrganizationSuccess() {
    OrganizationRequest request =
        new OrganizationRequest(1L, "OOO111", "Organization Test Name", "0001112233", "nya vagen");
    OrganizationResponse response =
        new OrganizationResponse(1L, "OOO111", "Organization Test Name", "0001112233", "nya vagen");
  ...
  public void findOrganizationById_Success() {
    ...
    OrganizationResponse response =
        new OrganizationResponse(
            organizationId, "OOO111", "Organization Test Name", "0001112233", "nya vagen");
  ...
  public void findOrganizationByKod_Success() {
    ...
    when(repository.findByKodOrganization(kodOrganization))
        .thenReturn(Optional.of(organizationEntity));

    OrganizationResponse actualResponse =
        adapter.findByOrganizationKod(new FindOrganizationByKodRequest(kodOrganization));
